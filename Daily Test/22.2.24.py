The program must accept the price P of an item as the input. The program must print the minimum number of coins needed to purchase the item as the output. The denominations of the coins are given below.
