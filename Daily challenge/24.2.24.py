...
Explanation:
After reversing the second array, the second array becomes 10 20 30 40 which is equal to the first array. Here, the given two arrays are mirror images of each other.
